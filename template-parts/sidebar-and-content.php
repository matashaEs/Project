					...
					<?php if ( ! empty( $search_results['products'] ) ) : ?>
                        ...
                        <div class="search-page__posts-container" id="products">
                            <div class="search-page__top">
                                ...
                                <a href="<?= site_url( '/products/' ) ?>" class="button search-page__button">See All
                                    Products</a>
                            </div>
                            <div class="search-page__posts">
								<?php foreach ( $search_results['products'] as $product ) { ?>
                                    <a class="search-page__post" href="<?= $product['url']; ?>">
                                        <div>
                                            <div class="h4  search-page__post-title"><?= $product['name']; ?></div>
											<?php if ( strlen( $product['description'] ) > 200 ) : ?>
                                                <div class="search-page__excerpt p"><?php echo substr( $product['description'], 0, 200 ) . '...'; ?></div>
											<?php endif; ?>
                                        </div>
                        ...
                        <div class="search-page__posts-container" id="categories">
                            ...
                            <div class="search-page__posts">
								<?php foreach ( $search_results['categories'] as $category ) { ?>
                                    <a class="search-page__post" href="<?= $category['url']; ?>">
                                        <div>
                                            <div class="h4 search-page__post-title"><?= $category['name']; ?></div>
											<?php if ( strlen( $category['description'] ) > 200 ) : ?>
                                                <div class="search-page__excerpt p"><?php echo substr( $category['description'], 0, 200 ) . '...'; ?></div>
											<?php endif; ?>
                                        </div>
                                        <div class="p search-page__read-more">
											<?= esc_html( __( 'Read More', 'nuplo' ) ) ?>
					...
					<?php if ( ! empty( $search_results['resources'] ) ) : ?>
                        ...
                        <div class="search-page__posts-container--resources" id="resources">
                            <div class="search-page__top">
                                ...
                                <a href="<?= site_url( '/resources/' ) ?>" class="button search-page__button">See
                                    All Resources</a>
                            </div>
                            <div class="search-page__posts">
								<?php foreach ( $search_results['resources'] as $resource ) { ?>
                                    <a class="search-page__post" href="<?= $resource['url']; ?>">
                                        <div class="search-page__top">
                                        ...
                                        <div class="h4 search-page__post-title"><?= $resource['name']; ?></div>
                                        <div class="p search-page__read-more">
											<?= esc_html( __( 'Read More', 'nuplo' ) ) ?>
                                        </div>
                                    </a>
                        ...
                        <div class="search-page__posts-container" id="other">
                            ...
                            <div class="search-page__posts">
								<?php foreach ( $search_results['other'] as $other ) { ?>
                                    <a class="search-page__post" href="<?= $other['url']; ?>">
                                        <div>
                                            <div class="h4 search-page__post-title"><?= $other['name']; ?></div>
											<?php if ( strlen( $other['description'] ) > 200 ) : ?>
                                                <div class="search-page__excerpt p"><?php echo substr( $other['description'], 0, 200 ) . '...'; ?></div>
											<?php endif; ?>
                                        </div>
                                        <div class="p search-page__read-more">
											<?= esc_html( __( 'Read More', 'nuplo' ) ) ?>
